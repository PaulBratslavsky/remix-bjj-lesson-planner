...
export default function Index() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32 min-h-screen">
      <img
        src="https://images.pexels.com/photos/5424766/pexels-photo-5424766.jpeg"
        alt="Jiu Jitsu Training"
        className="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center"
      />
      <div 
        className="absolute inset-0 bg-gray-900 opacity-90 -z-10"
        aria-hidden="true"
      ></div>
      <div
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">BJJ Class Viewer</h2>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            View all your planned classes.
          </p>
        </div>
